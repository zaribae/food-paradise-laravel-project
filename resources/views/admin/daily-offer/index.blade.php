                        ...
                        <div class="accordion-body collapse" id="panel-body-1" data-parent="#accordion" style="">
                            <form action="{{ route('admin.daily-offer.title.update') }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="daily_offer_top_title" id="top_title"
                                        value="{{ @$titles['daily_offer_top_title'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="main_title">Main Title</label>
                                    <input type="text" class="form-control" name="daily_offer_main_title" id="main_title"
                                        value="{{ @$titles['daily_offer_main_title'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="sub_title">Sub Title</label>
                                    <input type="text" class="form-control" name="daily_offer_sub_title" id="sub_title"
